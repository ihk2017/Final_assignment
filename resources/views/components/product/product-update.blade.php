                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 p-1">
                                <label class="form-label">Category Type Update</label>
...
<script>
    ...
    async function FillUpUpdateForm(id){
        try {
            ...
            document.getElementById('productCategoryUpdate').value=res.data['rows']['Producttype_id'];
        }catch (e) {
    ...
    async function update() {
        ...
        try {
            ...
            let PostBody= {
                ...
                "Producttype_id":productCategoryUpdate,
                "id":updateID
            }
