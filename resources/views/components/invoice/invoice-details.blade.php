        ...
        <div class="modal-content">
            ...
            <div id="invoice" class="modal-body p-3">
                    <div class="container-fluid ">
                        ...
                        <div class="row mt-5">
                            <div class="col-8">
                                <span class="text-bold bg-success text-dark">BILLED TO </span>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <p class="text-bold text-xs my-1 text-dark"> TOTAL:  <span id="total"></span> Taka</p>

                                <p class="text-bold text-xs my-1 text-dark"> VAT(5%):   <span id="vat"></span> Taka</p>
                                <p class="text-bold text-xs my-1 text-dark"> Discount:   <span id="discount"></span> Taka</p>
                                <hr>
                                <p class="text-bold text-xs my-2 text-dark"> PAYABLE:  <span id="payable"></span> Taka</p>
                            </div>
